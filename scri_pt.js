...
console.log("  5p3ctr3");
    ...
    function levelLineController() {
        ...
        if (levelLine.getElementsByClassName("loadline")[0])
            if (!game_over && score > 0 && score % 10 == 0) {
                levelLine.getElementsByClassName("loadline")[0].classList.remove("disappear");
                // levelLine.getElementsByClassName("loadline")[0].style.setProperty("animation","load 2s ease forwards");
                levelLine.getElementsByClassName("loadline")[0].style.width = 100 + "%";
                setTimeout(() => {
                    levelLine.getElementsByClassName("loadline")[0].classList.add("disappear");
                    setTimeout(() => {
                        levelLine.getElementsByClassName("loadline")[0].style.width = 0 + "%";
                    }, 1000);
                }, 1000);
            }
    ...
    function blinkEyes(times) {
        return;//doesnt look good hehh blinking eyes while moving uk
        if (times <= 0) return;
    ...
    function enableNightMode() {
        ...
        body.style.backgroundImage = "url(\"blacktris.jpg\")";
        // levelLine.style.backgroundColor = "#ffbb00";
        body.getElementsByClassName("topText")[0].style.color = "white";
    }
    function disableNightMode() {
        if (!NightMode) return;
        var body = document.getElementsByTagName("body")[0];
        body.style.backgroundImage = "url(\"whitetris.jpg\")";
    ...
    function erase() {
        ...
        levelLine = board.getElementsByClassName("line")[0];
        levelLine.innerHTML = "<div class=\"loadline\"></div><div class=\"sline\"></div>";
    ...
    function displayMessage(select) {
        ...
        messagediv.style.height = 1.1 * size;
        var message;
